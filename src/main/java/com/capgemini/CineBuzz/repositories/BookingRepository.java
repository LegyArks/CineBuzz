...
import com.capgemini.CineBuzz.dto.MovieRevenueReportDto;
...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    @Query("SELECT new com.capgemini.CineBuzz.dto.MovieRevenueReportDto(m.title, SUM(b.seatsBooked), SUM(b.seatsBooked * m.price)) " +
